...
const Post: React.FC<{post: IPost, setPosts: React.Dispatch<React.SetStateAction<never[]>>}> = ({post, setPosts}) => {
    ...
    const Header = () => (
        <div className="bg-primary py-24px px-30px d-flex justify-content-between">
            <h2 className="text-white fs-22px fw-700 text-capitalize">{post.title}</h2>
            {
    ...
    const Body = () => (
        <>
            <div className="px-30px pt-24px d-flex justify-content-between">
                ...
                <span className="text-gray fs-18px fw-400">{diffTime(new Date(post.created_datetime), new Date())}</span>
            </div>
                ...
                {showDelete ? 
                    <Modal.Body className="pt-34px px-34px">
                        ...
                        <div className="d-flex justify-content-end pb-26px px-34px pt-30px">
                            <Button variant="outline-dark" className="me-20px rounded-0 w-111px" onClick={handleClose}>
                                Cancel
                            </Button>
                            <Button variant="outline-dark" className="rounded-0 w-111px" onClick={() => deletePost()}>
                                OK
                            </Button>
                        </div>
                    </Modal.Body>
                    :
                    <>
                    <Modal.Header className="border-0 px-34px pt-34px fs-22px fw-700 w-100">Edit item</Modal.Header>
